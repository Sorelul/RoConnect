...
<head>
    ...
    <title>Conectare | RoConnect</title>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="p-4">
                        ...
                        <h1 class="mb-3 text-18">Conectare</h1>
                        <form id="login-form">
                            ...
                            <button class="btn btn-rounded btn-primary btn-block mt-2">Conectează-te</button>
                        </form>
                        <div class="mt-3 text-center"><a class="text-muted" href="/auth/forgot_password">
                                <u>Ți-ai uitat parola?</u></a></div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $('#login-form').submit(function(e) {
            ...
            if (email == '' || password == '') {
                toastr.error('Toate campurile trebuie completate!', "Uops! A aparut o eroare.");
                return;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.error == false) {
                        ...
                        toastr.error(response.message, "Uops! A aparut o eroare.");
                    }
                }
            });
        });
